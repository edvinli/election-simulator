...
def main() -> int:
    ...
    supplementary_record = manifest["sources"]["swedishpolls"]
    swedishpolls_wide, swedishpolls = parse_swedishpolls_payloads(
        ...
        retrieved_at=supplementary_record["retrieved_at"],
    )
    crosswalk = enrich_with_swedishpolls(
        individual,
        swedishpolls_wide,
        metadata_retrieved_at=supplementary_record["retrieved_at"],
    )
